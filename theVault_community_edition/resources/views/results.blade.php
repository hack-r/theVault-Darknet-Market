    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-6">
                    <h4 class="float-left">
                        Search results for "{{ $query }}" @if(request('user')) by user {{ request('user') }} @endif
                    </h4>
                </div>
                <div class="col-5">
                    <p class="float-right text-secondary small mt-2 ">
                        Fetched {{ $results_count }} 
                        {{ \Illuminate\Support\Str::plural('result', $products->count()) }}
                        in {{ $time }} 
                        {{ \Illuminate\Support\Str::plural('second', $time) }}
                    </p>
                </div>
                <div class="col-md-1">
