            ...
            <div class="col-md-12 text-center">
                ...
                <form action="{{ route('profile.cart.add', $product) }}" method="POST">
                    ...
                    <table class="table border-0 text-left table-borderless">
                        ...
                        <tr>
                            <td class="text-right text-muted">Type</td>
                            <td>
                                <strong class="badge badge-info">{{ ucfirst($product->type) }}</strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-right text-muted">Offers</td>
                            <td>
                                <ul>
                        ...
                        <tr>
                            <td class="text-right text-muted">Coins</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge badge-light">{{ $product->numberOfPurchases() }} {{ Str::plural($product->mesure, $product->orders) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                @if($product->user->vendor->experience < 0)
                                    <p class="text-danger border border-danger rounded p-1 mt-2">
                                        <span class="fas fa-exclamation-circle"></span> Negative experience, trade with caution!
                                    </p>
                                @endif
                            </td>
                        </tr>
                        ...
                        <tr class="bg-light">
                            ...
                            <td class="row">
                                ...
                                <div class="col-md-7">
                                    <button class="btn btn-sm btn-block mb-2 btn-primary">
                                        ...
                                        @if(auth()->user()->isWhishing($product))
                                            <a href="{{ route('profile.wishlist.add', $product) }}"
                                               class="btn btn-outline-secondary btn-block btn-sm">
                                                <i class="far fa-heart"></i> Remove from wishlist
                                            </a>
                                        @else
                                            <a href="{{ route('profile.wishlist.add', $product) }}"
    ...
    <div class="col-md-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <hr>
                <a href="{{ route('profile.messages').'?otherParty='.$product->user->username }}" class="btn mb-1 btn-outline-secondary">
                    <span class="fas fa-envelope"></span> Send message
                </a>
                <a href="{{ route('search', ['user' => $product->user->username]) }}" class="btn mb-1 btn-outline-info">
                    Seller's products ({{$product->user->products()->count()}})
                </a>
            </div>
        </div>
    </div>
